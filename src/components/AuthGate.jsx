...
export default function AuthGate() {
  ...
  if (timedOut) {
    return (
      <div className="fixed inset-0 flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 z-[9999] px-6">
        <div className="relative mb-4">
          <img src="/logo.png" className="w-14 h-14 object-contain opacity-60" alt="Logo" />
        </div>
        <p className="text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Không thể tải dữ liệu xe</p>
        <p className="text-xs text-gray-400 mb-6 text-center max-w-xs">
          Có thể do lỗi mạng tạm thời hoặc phiên đăng nhập đã hết hạn.
        </p>
